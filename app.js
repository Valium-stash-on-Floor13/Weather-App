...
button.addEventListener('click', ()=>{
  getInfoByPos(input.value);
  input.value='';
  input.placeholder='';
})

function getInfoByPos(city){
       
  const api= `https://api.openweathermap.org/data/2.5/weather?q=${city}&appid=e46bc53d5357dc5f11a54ec4136d8f96`
  fetch(api)
      .then(response=>{
